...
export const Error = () => {
    const [value, setValue] = useState('');
    return (
        <Input elementType="input" type="text" placeholder="" value={value} onChange={setValue} error></Input>
    );
};
...
export const Password = () => {
    const [value, setValue] = useState('');
    return (
        <Input elementType="input" type="password" placeholder="Password" icon="Password" value={value} onChange={setValue}></Input>
    );
};
...
export const Radio = () => {
    const [value, setValue] = useState('');
    return (
        <Input elementType="radio" placeholder="" value={value} onChange={setValue}></Input>
    );
};
