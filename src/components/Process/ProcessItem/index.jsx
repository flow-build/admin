...
const ProcessItem = ({
  id, createdAt, status, stepNumber, nodeId, nextNodeId, lastUpdated, processCheck, action, workflowId, workflowName,
}) => {
  ...
  const redirectProcess = () => {
    history.push(`/app/process/${workflowName}/${workflowId}/${id}`);
  };
